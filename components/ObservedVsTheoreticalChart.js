...
export default function ObservedVsTheoreticalChart({ data }) {
  ...
  const rows = [...data]
    ...
    .map((d) => ({
      ...
      "Real team lists": d.observed_rate,
  ...
  return (
    <div className="card">
      ...
      <p className="text-xs text-white/50 mb-4">
        Share of team lists where at least two players share a birthday.
        Top 15 sports by number of real team lists in the dataset.
      </p>
